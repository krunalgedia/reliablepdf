...
$custom_settings = " -dProcessColorModel=/DeviceGray -dColorConversionStrategy=/Gray -dPDFUseOldCMS=false ";
...
$command = append_string($gsexec,$dBatch,$dNopause,$sDevice,$selectedsDevice,$custom_settings,$sOutputFile,$selectedsOutputFile," ",$inputfile);
exec($command);
echo "$command";
